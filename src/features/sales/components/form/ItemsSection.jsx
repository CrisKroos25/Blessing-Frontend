...
function getStockInfo(stock, stockMinimum) {
    ...
    if (stock <= stockMinimum)
        return { label: 'Bajo', className: styles.stockLow };
    return { label: 'En stock', className: styles.stockOk };
}
...
export default function ItemsSection({ products = [], onAdd, error }) {
    // `query` controla el texto del buscador
